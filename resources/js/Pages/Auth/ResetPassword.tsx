...
export default function ResetPassword({ token, email }) {
    ...
    return (
        <GuestLayout>
            <Head title="تنظیم رمز عبور جدید">
            ...
            <form onSubmit={submit}>
                ...
                <div className="mt-4">
                    ...
                    <TextInput id="password" type="password" name="password" value={data.password} className="mt-1 block w-full" autoComplete="new-password" onChange={(e) => setData('password', e.target.value)} />
